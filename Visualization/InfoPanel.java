...
public class InfoPanel {
    ...
    private SettingsPanel settingsPanel; // Reference to SettingsPanel

    // Updated constructor to accept SettingsPanel reference
    public InfoPanel(String algorithm, SettingsPanel settingsPanel) {
        this.algorithm = algorithm;
        this.settingsPanel = settingsPanel; // Initialize settingsPanel
    }
    ...
    public void showMoreInfo() {
        System.out.println("showMoreInfo called"); // Debugging line
