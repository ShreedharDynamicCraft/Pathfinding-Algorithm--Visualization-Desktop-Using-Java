...
public class Panel extends JPanel {
    ...
    public void createNodes() {
        for (int row = 0; row < numRow; row++) {
            for (int col = 0; col < numCol; col++) {
                nodesGrid[row][col] = new Node(row, col, true); // Assuming false means no wall
            }
        }
        for (int row = 0; row < numRow; row++) {
            for (int col = 0; col < numCol; col++) {
    ...
    //     this.maze = maze; // Adjust this according to your implementation
    //     repaint(); // If you want to refresh the display after setting the maze
    // }
    public void setMaze(int[][] maze) {
        this.maze = maze;
        this.rows = maze.length;
        this.cols = maze[0].length;
        numRow = rows; // Adjust this according to your implementation
        numCol = cols; // Adjust this according to your implementation
        createNodes(); // Recreate nodes based on new dimensions
        repaint(); // Refresh the display after setting the maze
    }
